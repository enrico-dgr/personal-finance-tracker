...
export default function App() {
  ...
  const rulePreviewCountOnFiltered = countMatchingTransactions(
    {
      pattern: rulePattern.trim() || normalizedDescription.trim(),
      patternType: rulePatternType,
    },
              ...
              <div className="correction-summary">
                ...
                {selectedTransactionIds.length ? (
                  <p className="inline-note">
                    ...
                    {selectedTransactionIds.length} righe selezionate la regola
                    corrente continua a fare match.
                  </p>
                ) : (
                  <p className="empty-state">
          ...
          >
            ...
            <form className="editor-form" onSubmit={handleSaveTransaction}>
              <div className="editor-highlight">
                ...
                <span>Merchant originale: </span>
                <small>
                  <i>{selectedTransaction?.originalDescription || 'Nessuno'}</i>
                </small>
              </div>
              ...
              <p className="inline-note">
                Con questa configurazione la regola matcha{' '}
                {rulePreviewCountOnFiltered} righe su{' '}
                {paginatedTransactions.length} visibili.
              </p>
